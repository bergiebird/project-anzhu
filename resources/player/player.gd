...
func _music_check()->void:
	if global_position.distance_to(Vector2(211,153)) < 150.0:
		bgm.stop()
	elif not bgm.is_playing():
		bgm.play()
...
func set_efficiency(new_value :bool)->void: is_efficient = new_value
func get_efficiency()->bool: return is_efficient
func set_can_fire(new_value :bool)->void: can_fire = new_value
func get_can_fire()->bool: return can_fire
func set_can_move(new_value :bool)->void: can_move = new_value
func get_can_move()->bool: return can_move
