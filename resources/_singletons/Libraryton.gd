...
func _ready()->void:
	player_reference.connect(func():print('yarp'))
...
func _remove_digits_from_string()->void: pattern_that_removes_digits.compile('\\d')
...
var lambda2 :Callable = func(child1,child2): pass
var lambda1 :Callable = func(child):pass
...
func reference_emitter_deferred(ref_signal :String, ref)->void:
