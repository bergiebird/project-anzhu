...
extends CanvasModulate #day_night_modulator.gd
...
var tween :Tween
var lerp_times :Array = [dawn_lerp_time,morning_lerp_time,noon_lerp_time,afternoon_lerp_time,dusk_lerp_time,\
night_lerp_time,midnight_lerp_time,late_night_lerp_time]
