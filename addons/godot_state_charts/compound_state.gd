@tool @icon("compound_state.svg") class_name CompoundState extends StateChartState
# A compound state is a state that has multiple sub-states of which exactly one can be active at any given time.
