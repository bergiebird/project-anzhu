...
const SettingsManager :Resource = preload("res://addons/fancy_editor_sounds/FancyEditorSoundSettings.gd")
...
enum ActionType {NONE, TYPING, DELETING, SELECTING, SELECTING_ALL, SELECTING_WORD,
 DESELECTING, CARET_MOVING, UNDO, REDO, COPY, PASTE, SAVE, ZAP_REACHED, INTERFACE_BUTTON_CLICK,
 INTERFACE_BUTTON_ON, INTERFACE_BUTTON_OFF, INTERFACE_SLIDER_TICK, INTERFACE_HOVER,}
enum DeleteDirection {LEFT,RIGHT,LINE,SELECTION,}
enum AnimationType {STANDARD,ZAP}
#endregion
